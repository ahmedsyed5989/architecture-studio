...
```html
<link rel="stylesheet" href="https://esm.sh/@tumaet/apollon@5.4.0/style.css" />
<div id="apollon" style="width: 100%; height: 600px"></div>

<script type="module">
  import { ApollonEditor } from "https://esm.sh/@tumaet/apollon@5.4.0"
...
import {
  ...
  ApollonMode,
  UMLDiagramType,
} from "https://esm.sh/@tumaet/apollon@5.4.0"
